Public Class binary_style
    ...
    Private Sub Form1_MouseMove(ByVal sender As Object, ByVal e As MouseEventArgs) Handles MyBase.MouseMove, PictureBox1.MouseMove, PictureBox2.MouseMove, PictureBox3.MouseMove, PictureBox4.MouseMove, PictureBox5.MouseMove, PictureBox6.MouseMove, PictureBox11.MouseMove, PictureBox12.MouseMove, PictureBox13.MouseMove, PictureBox14.MouseMove, PictureBox15.MouseMove, PictureBox16.MouseMove, PictureBox17.MouseMove, PictureBox18.MouseMove, PictureBox21.MouseMove, PictureBox22.MouseMove, PictureBox23.MouseMove, PictureBox24.MouseMove, PictureBox25.MouseMove, PictureBox26.MouseMove, Label1.MouseMove, MenuStrip1.MouseMove
        ...
        End If
    End Sub
    Private Sub binary_style_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Text = myappfullname & " - Binary Style Clock"
        Me.FormBorderStyle = Windows.Forms.FormBorderStyle.None
        Me.TopMost = True
        '
        binary_style_show_time()
        Timer1.Start()
    End Sub
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer2.Tick
        binary_style_show_time_digital_font()
    End Sub

    Private Sub DigitalTechFontToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DigitalTechFontToolStripMenuItem.Click
        BasicaFontToolStripMenuItem.Checked = False
        DigitalTechFontToolStripMenuItem.Checked = True
        '
        Timer1.Stop()
        Timer2.Start()
    End Sub

    Private Sub BasicaFontToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BasicaFontToolStripMenuItem.Click
        BasicaFontToolStripMenuItem.Checked = True
        DigitalTechFontToolStripMenuItem.Checked = False
        '
        Timer1.Start()
        Timer2.Stop()
    End Sub
